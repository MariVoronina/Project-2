...
elec_list = ["Да", "Нет"] # список для выбора наличия электричества при работе с интерфейсом
heat_list = ["Газовое", "Электрическое", "Дровяное"] # список для выбора типа отопления при работе с интерфейсом
ws_list = ["Да", "Нет"] # список для выбора наличия водоснабжения при работе с интерфейсом
